...
{	
	...
	m_ShadowMatrix[0][3] = -lightPos[3] * plane[0];
	m_ShadowMatrix[1][3] = -lightPos[3] * plane[1];
	m_ShadowMatrix[2][3] = -lightPos[3] * plane[2];
	m_ShadowMatrix[3][3] = dot - lightPos[3] * plane[3];
